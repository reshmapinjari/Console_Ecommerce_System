...

{
    ...
    public class GetOnlineReturnBLTest
    {
        ...
        public async Task GetOnlineReturnByCustomerIDBL()
        {
            ...
            try
            {
               List<OnlineReturn> onlineReturn1 = await onlineReturnBL.GetOnlineReturnByCustomerIDBL(onlineReturn.CustomerID);
        ...
        public async Task CustomerIDDoesNotExist()
        {
            ...
            try
            {
                List<OnlineReturn> onlineReturnList1 = await onlineReturnBL.GetOnlineReturnByCustomerIDBL(default(Guid));
